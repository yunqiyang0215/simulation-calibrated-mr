...
legend("topleft", legend = c("Gaussian: tau.tilde", "Gaussian: tau.raw", 
                             "Binary: tau.raw","Binary: tau.raw"), col = c(2,1), pch = c(19, 19, 17, 17))
```
...
for (i in 1:length(rhos)){
  var1[i, ] <- apply(gaussian[[i]], MARGIN = 2, function(x) var(x))
  var2[i, ] <- apply(binary[[i]], MARGIN = 2, function(x) var(x))
}
