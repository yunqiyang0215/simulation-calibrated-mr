...
pdf("/Users/nicholeyang/Downloads/simulation-calibrated-mr/output/ukb_mr_trio1.pdf", width = 12, height = 4)
par(mfrow = c(1,3))
...
plot_combined_res(res.mr, main = paste0("IVW:", exp, " on edu_yrs"))
...
plot_combined_res(res.mr, main = paste0("mr.raps.mle:", exp, " on edu_yrs"))
...
plot_combined_res(res.mr, main = paste0("mr.raps.shrinkage:", exp, " on edu_yrs"))
```
...
```{r fig.width=12, fig.height = 4}
pdf("/Users/nicholeyang/Downloads/simulation-calibrated-mr/output/ukb_mr_sib1.pdf", width = 12, height = 4)
par(mfrow = c(1,3))
pvals = c(1e-2, 1e-5, 1e-8)
...
plot_combined_res(res.mr, main = paste0("IVW:", exp, " on EduYrs"))
...
plot_combined_res(res.mr, main = paste0("mr.raps.mle:", exp, " on EduYrs"))
...
plot_combined_res(res.mr, main = paste0("mr.raps.shrinkage:", exp, " on EduYrs"))
```
