...
```{r}
bmi_snps <- read.table("/Users/nicholeyang/Downloads/calibrated_estimator/real-data-analysis/result/bmi.txt", header = FALSE)
```
...
```{r}
dat.exp = dat.exp[dat.exp$variant %in% bmi_snps$V1, ]
dat.out = dat.out[dat.out$variant %in% bmi_snps$V1, ]
...
# Plotting
plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
     xaxt='n', pch=19, xlab='', ylab='Point Estimate', main='IVW: BMI on education years', cex=1.5)
arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
axis(1, at=1:4, labels=labels)
```
...
# Plotting
plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
     xaxt='n', pch=19, xlab='', ylab='Point Estimate', main='IVW: BMI on smoking', cex=1.5)
arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
axis(1, at=1:4, labels=labels)
```
...
# Plotting
plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
     xaxt='n', pch=19, xlab='', ylab='Point Estimate', main='mr.raps: BMI on smoking', cex=1.5)
arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
axis(1, at=1:4, labels=labels)
