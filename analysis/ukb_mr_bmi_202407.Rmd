...
for (i in 1:length(pvals)){
  ...
  colnames(res.mr) = c("calibrated", "raw", "internal.gwas", "external.gwas")
  ...
  labels <- c('calibrated', 'raw', 'internal.gwas', 'external.gwas')
  point_est <- res.mr[1, ]
  error_bars <- 1.96 * res.mr[2, ]
  
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('IVW: BMI on diabetes: pval=', pvals[i]) , cex=1.5)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.mle: BMI on diabetes: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.shrinkage: BMI on diabetes: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
...
for (i in 1:length(pvals)){
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('Debiased IVW: BMI on diabetes: pval=', pvals[i]) , cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
}
```
...
for (i in 1:length(pvals)){
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('IVW: BMI on EduYrs: pval=', pvals[i]) , cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.mle: BMI on EduYrs: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.shrinkage: BMI on EduYrs: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
...
for (i in 1:length(pvals)){
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('IVW: BMI on smoking: pval=', pvals[i]) , cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.mle: BMI on smoking: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.shrinkage: BMI on smoking: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
...
for (i in 1:length(pvals)){
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('IVW: BMI on sbp: pval=', pvals[i]) , cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.mle: BMI on sbp: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.shrinkage: BMI on sbp: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
...
for (i in 1:length(pvals)){
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('IVW: BMI on dbp: pval=', pvals[i]) , cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.mle: BMI on dbp: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('mr.raps.shrinkage: BMI on dbp: pval=', pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
