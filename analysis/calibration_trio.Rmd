...
x_values = c(1, 2, 3)
plot(x = as.factor(rep(x_values, p)), y = c(vr), xlab = "r1 value", ylab = "Empirical variance reduction", xaxt="n", pch = 20,ylim = c(0, 1), boxwex = 0.5, main = "Linear regression")
...
# Create a vector for equally spaced x-values
x_values = c(1, 2, 3)
plot(x = as.factor(rep(x_values, p)), y = c(vr), xlab = "r1 value", ylab = "Empirical variance reduction", xaxt="n", pch = 20, ylim = c(0, 1), boxwex = 0.5, main = "Logistic regression")
axis(1, at = x_values, labels = c("0", "0.1", "0.5"))
abline(h = theo_vr, col = "red", lty = 2)
```
