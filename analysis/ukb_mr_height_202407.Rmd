...
for (i in 1:length(pvals)){
  ...
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main=paste0('IVW: ', exp, " on ", out, ": pval=", pvals[i]) , cex=1.5)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main= paste0('Debiased IVW: ', exp, " on ", out, ": pval=", pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main= paste0('mr.raps.mle: ', exp, " on ", out, ": pval=", pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
  ...
  # Plotting
  plot(1:4, point_est, ylim=c(min(point_est - error_bars), max(point_est + error_bars)),
       xaxt='n', pch=19, xlab='', ylab='Point Estimate', main= paste0('mr.raps.shrinkage: ', exp, " on ", out, ": pval=", pvals[i]), cex=1.5)
  arrows(1:4, point_est - error_bars, 1:4, point_est + error_bars, angle=90, code=3, length=0.1, col='red')
  axis(1, at=1:4, labels=labels)
