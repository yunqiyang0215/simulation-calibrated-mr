...
```{r}
dat = readRDS("/project2/mstephens/yunqiyang/calibrated_mr/simulation_sibling/linear202403/res_mr.rds")
```
...
for(i in 1:length(r1)) {
  for(j in 1:length(r2)) {
    res <- dat[dat$sim_data.r1 == r1[i] & dat$sim_data.r2 == r2[j] & dat$sim_effect.p ==10 & dat$sim_data.sig == 1 & dat$mr.mr_method == "mr.raps", ]
    cali_point = res$mr.point_est[res$fit.method == "calibrated"]
    adj_uncali_point = res$mr.point_est[res$fit.method == "adj_uncalibrated"]
    cali = (res$mr.stderr[res$fit.method == "calibrated"])^2
    adj_uncali = (res$mr.stderr[res$fit.method == "adj_uncalibrated"])^2
...
boxplot(cali_point ~ combination, data = aggregated_data, at = 1:length(levels(aggregated_data$combination)) - 0.2, col = "lightblue", add = TRUE, pch = 20, cex = 0.5, boxwex = 0.3, xaxt = "n")
boxplot(adj_uncali_point ~ combination, data = aggregated_data, at = 1:length(levels(aggregated_data$combination)) + 0.2, 
        col = "gold", add = TRUE, pch = 20, cex = 0.5, boxwex = 0.3, xaxt = "n")
legend("topright", legend = c("Calibrated", "Uncalibrated"), fill = c("lightblue", "gold"), bty = "n", cex = 0.8)
...
plot(1, type = "n", xlab = "r1, r2 value", ylab = "Variance", xlim = c(0.5, length(levels(aggregated_data$combination)) + 0.5), ylim = c(-0.01, 0.02), xaxt = "n", main = "Variance of MR estimates")
axis(1, at = 1:length(levels(aggregated_data$combination)), labels = levels(aggregated_data$combination), las = 2, cex.axis = 0.6)
...
plot(1, type = "n", xlab = "r1, r2 value", ylab = "Variance Reduction", 
     xlim = c(0.5, length(levels(aggregated_data$combination)) + 0.5), 
     ylim = c(-0.5, 0.5), xaxt = "n", main = "Variance Reduction")
...
for(i in 1:length(r1)) {
  for(j in 1:length(r2)) {
    res <- dat[dat$sim_data.r1 == r1[i] & dat$sim_data.r2 == r2[j] & dat$sim_effect.p ==10 & dat$sim_data.sig == 10 & dat$mr.mr_method == "mr.raps", ]
    cali_point = res$mr.point_est[res$fit.method == "calibrated"]
    adj_uncali_point = res$mr.point_est[res$fit.method == "adj_uncalibrated"]
    cali = (res$mr.stderr[res$fit.method == "calibrated"])^2
    adj_uncali = (res$mr.stderr[res$fit.method == "adj_uncalibrated"])^2
...
plot(1, type = "n", xlab = "r1, r2 value", ylab = "value", xlim = c(0.5, length(levels(aggregated_data$combination)) + 0.5), ylim = c(-2, 2), xaxt = "n", main = "Point estimate: mr.raps")
axis(1, at = 1:length(levels(aggregated_data$combination)), labels = levels(aggregated_data$combination), las = 2, cex.axis = 0.6)
...
plot(1, type = "n", xlab = "r1, r2 value", ylab = "Variance", xlim = c(0.5, length(levels(aggregated_data$combination)) + 0.5), ylim = c(-1, 5), xaxt = "n", main = "Variance of MR estimates")
axis(1, at = 1:length(levels(aggregated_data$combination)), labels = levels(aggregated_data$combination), las = 2, cex.axis = 0.6)
...
plot(1, type = "n", xlab = "r1, r2 value", ylab = "Variance Reduction", 
     xlim = c(0.5, length(levels(aggregated_data$combination)) + 0.5), 
     ylim = c(-2, 2), xaxt = "n", main = "Variance Reduction")
