...
### 1. BMI: selection based on trio data pvalue < 5e-3
...
### 2. BMI:  selection based on sibling data pvalue < 1e-3
```{r}
par(mfrow = c(1,2))
res <- merge_int_ext_res(dir.int = "/Users/nicholeyang/Downloads/calibrated_estimator/real-data-analysis/result/mr_gwas_sibling/",
                         trait = "bmi")
...
# sibling
plot(dat$cali, dat$raw, xlab = "Calibrated estimator (+- 1.96*sd)", ylab = "Raw estimator (+- 1.96*sd)", pch = 20, xlim = c(-0.01, 0.1), ylim = c(-0.01, 0.1), main = "BMI: sibling")
arrows(dat$cali - 1.96*dat$cali_error, dat$raw, 
       dat$cali + 1.96*dat$cali_error, dat$raw, 
       angle = 90, code = 3, length = 0.02, col = "grey")
arrows(dat$cali, dat$raw - 1.96*dat$raw_error, 
...
plot(dat$cali, dat$raw, xlab = "Calibrated estimator (+- 1.96*sd)", ylab = "Raw estimator (+- 1.96*sd)", pch = 20, xlim = c(-0.2, 0.3), ylim = c(-0.2, 0.3), main = "BMI: trio")
arrows(dat$cali - 1.96*dat$cali_error, dat$raw, 
       dat$cali + 1.96*dat$cali_error, dat$raw, 
       angle = 90, code = 3, length = 0.02, col = "grey")
arrows(dat$cali, dat$raw - 1.96*dat$raw_error, 
...
### 3. Diabetes: selection based on trio data pvalue < 1e-2
...
plot(dat$cali, dat$raw, xlab = "Calibrated estimator (+- 1.96*sd)", ylab = "Raw estimator (+- 1.96*sd)", pch = 20, xlim = c(-0.06, 0.06), ylim = c(-0.06, 0.06), main = paste0(trait, ": sibling"))
arrows(dat$cali - 1.96*dat$cali_error, dat$raw, 
       dat$cali + 1.96*dat$cali_error, dat$raw, 
       angle = 90, code = 3, length = 0.02, col = "grey")
arrows(dat$cali, dat$raw - 1.96*dat$raw_error, 
...
### 4. Diabetes:  selection based on sibling data pvalue < 5e-3
```{r}
par(mfrow = c(1,2))
trait = "diabetes"
res <- merge_int_ext_res(dir.int = "/Users/nicholeyang/Downloads/calibrated_estimator/real-data-analysis/result/mr_gwas_sibling/",
...
### 5. Education Years: selection based on trio data pvalue < 5e-3
...
### 6. Education Years:  selection based on sibling data pvalue < 1e-2
```{r}
par(mfrow = c(1,2))
trait = "education_yrs"
res <- merge_int_ext_res(dir.int = "/Users/nicholeyang/Downloads/calibrated_estimator/real-data-analysis/result/mr_gwas_sibling/",
