...
### 0. Check result for G&Gpa model and T&NT model

```{r}
sumstat1 = readRDS("/Users/nicholeyang/Downloads/calibrated_estimator/real-data-analysis/result/trio_calibration_bmi.rds")
sumstat2 = readRDS("/Users/nicholeyang/Downloads/calibrated_estimator/real-data-analysis/result/trio_calibration_NT_bmi.rds")
```
...
```{r}
sumstat1 = readRDS("/Users/nicholeyang/Downloads/calibrated_estimator/real-data-analysis/result/trio_calibration_education_yrs.rds")
sumstat2 = readRDS("/Users/nicholeyang/Downloads/calibrated_estimator/real-data-analysis/result/trio_calibration_NT_education_yrs.rds")
```
...
colnames(vr) = c("bmi", "sbp", "dbp", "diabetes", "edu_yrs")
```
