...
# Add error bars
arrows(x0 = x_pos, y0 = means - 1.96*ses, x1 = x_pos, y1 = means + 1.96*ses, code = 3,
      length = 0.05, lwd = 2, col = rep(c("coral1", "skyblue", "gold"), ncomb))
abline(h = 1, lty =2, col = "grey")

axis(1, at = c(1:ncomb), labels = labels, cex.axis = 0.6)
legend("topleft", legend = c("calibrated", "adjusted, uncalibrated", "unadjusted"), lty = 1, col = c("coral1", "skyblue", "gold"))
```
...
legend("topleft", legend = c("calibrated", "adjuted+uncali", "unadjusted"), lty = 1, col = c("coral1", "skyblue", "gold"))
```
