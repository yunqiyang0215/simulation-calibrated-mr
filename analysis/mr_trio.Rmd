...
plot(x = x_pos, y = means, ylim = range(means - 2*ses, means + 2*ses), pch = 20,
     xlab = "", ylab = "Mean Value", main = "MR estimates: IVW", xaxt = 'n')
# Add error bars
...
plot(x = x_pos, y = means, ylim = range(means - 2*ses, means + 2*ses), pch = 20,
     xlab = "", ylab = "Mean Value", main = "MR estimates: mr.raps", xaxt = 'n')
# Add error bars
arrows(x0 = x_pos, y0 = means - 1.96*ses, x1 = x_pos, y1 = means + 1.96*ses,
       code = 3, angle = 90, length = 0.05, lwd = 2, col = rep(c("coral1", "skyblue", "gold"), ncomb))
abline(h = 1, lty =2, col = "grey")
...
# Add error bars
arrows(x0 = x_pos, y0 = means - 1.96*ses, x1 = x_pos, y1 = means + 1.96*ses,
       code = 2, angle = 90, length = 0.05, lwd = 2, col = rep(c("coral1", "skyblue"), ncomb))
