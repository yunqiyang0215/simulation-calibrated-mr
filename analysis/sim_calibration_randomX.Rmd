...
for (i in 1:p){
  ...
  stats <- combine_single_snp_stat(which(res$sim_data.r1 == r1[k]), i, data.list = res$fit.sumstat, column_names = c("Y1.cali.var", "Y1.var.raw"))
...
for (i in 1:p){
  snp_dat_list = lapply(1:length(r1), function(k) combine_single_snp_stat(which(res$sim_data.r1 == r1[k]), i, data.list = res$fit.sumstat, column_names = c("Y2.cali", "Y2.raw")))
  ...
  ### Plot variance
  empirical_var = apply(dat_estimator, 2, var)
  snp_dat_list = lapply(1:length(r1), function(k) combine_single_snp_stat(which(res$sim_data.r1 == r1[k]), i, data.list = res$fit.sumstat, column_names = c("Y2.cali.var", "Y2.var.raw")))
  dat_estimator_var <- do.call(cbind, snp_dat_list)
...
for (i in 1:p){
  snp_dat_list = lapply(1:length(r2), function(k) combine_single_snp_stat(which(res$sim_data.r2 == r2[k]), i, data.list = res$fit.sumstat, column_names = c("Y2.cali", "Y2.raw")))
  ...
  ### Plot variance
  empirical_var = apply(dat_estimator, 2, var)
  snp_dat_list = lapply(1:length(r2), function(k) combine_single_snp_stat(which(res$sim_data.r2 == r2[k]), i, data.list = res$fit.sumstat, column_names = c("Y2.cali.var", "Y2.var.raw")))
  dat_estimator_var <- do.call(cbind, snp_dat_list)
...
for (i in 1:p){
  ...
  # Calculate variance reduction
  snp_dat_list <- lapply(1:length(r1), function(k) {
  stats <- combine_single_snp_stat(which(res$sim_data.r1 == r1[k]), i, data.list = res$fit.sumstat, column_names = c("Y2.cali.var", "Y2.var.raw"))
...
for (i in 1:p){
  ...
  stats <- combine_single_snp_stat(which(res$sim_data.r2 == r2[k]), i, data.list = res$fit.sumstat, column_names = c("Y2.cali.var", "Y2.var.raw"))
  variance_reduction <- (stats[,"Y2.var.raw"] - stats[,"Y2.cali.var"]) / stats[,"Y2.var.raw"]
  return(variance_reduction)
})
