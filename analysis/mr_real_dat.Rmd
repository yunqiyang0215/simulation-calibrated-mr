...
In this case, $T$ and $NT$ are independent, so $r=0$. $\sigma^2=0.001, \rho=0.1$. $\beta_2=0.001$. Therefore, VR = 0.4499955.

This is a rough sanity check. The variance reduction here agrees with the theoretical value, even though SNPs are not iid. 
```{r}
v = (1-0.1)/2*0.001/(0.001+0.001^2)
par(mfrow = c(1,2))
...
hist(vr2, breaks = 20, main = "variance reduction", xlab = "exposure trait")
