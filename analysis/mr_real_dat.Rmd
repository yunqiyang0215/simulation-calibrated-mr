...
for (i in 1:p){
  ...
  dat2_valid <- cbind(dat[["pheno"]][1:n,2], dat[["T.y2"]][1:n, i], dat[["NT.y2"]][1:n, i]) 
  ...
  y1.raw[i, ] = res1$tau_raw
  y2.raw[i, ] = res2$tau_raw
}
...
```{r}
par(mfrow = c(2,2))
hist(y1.cali[,1], main = "Y1: Calibrated estimator of Tj - NTj", xlab = "", breaks  = 20)
hist(y1.raw[,1], main = "Y1: Raw estimator of Tj - NTj", xlab = "", breaks  = 20)
hist(y2.cali[,1], main = "Y2: Calibrated estimator of Tj - NTj", xlab = "", breaks  = 20)
hist(y2.raw[,1], main = "Y2: Raw estimator of Tj - NTj",  xlab = "", breaks  = 20)
```
