---
title: "MR result: trio data logistic regression"
output: html_document
date: '2024-02-09'
---

```{r}
dat = readRDS("/project2/mstephens/yunqiyang/calibrated_mr/simulation_trio/logistic202403/res_mr.rds")
effect.true = readRDS("/project2/mstephens/yunqiyang/calibrated_mr/simulation-calibrated-mr/data/logistic_mr_estimate.RData")
```
...
points_at <- 1:length(levels(aggregated_data$combination))  
MR_estimate_values <- effect.true$MR_estimate 
points(points_at, MR_estimate_values, pch = 4, col = "red", cex = 0.6)
...
plot(1, type = "n", xlab = "r1, r2 value", ylab = "Variance Reduction", 
     ...
     ylim = c(-1.05, 1), xaxt = "n", main = "Variance Reduction")
...
plot(1, type = "n", xlab = "r1, r2 value", ylab = "value", xlim = c(0.5, length(levels(aggregated_data$combination)) + 0.5), ylim = c(0, 2), xaxt = "n", main = "Point estimate: mr.raps")
axis(1, at = 1:length(levels(aggregated_data$combination)), labels = levels(aggregated_data$combination), las = 2, cex.axis = 0.6)
