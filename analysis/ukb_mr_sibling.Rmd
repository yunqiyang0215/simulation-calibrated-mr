...
```{r}
# BMI
sumstat = readRDS("/project2/mstephens/yunqiyang/calibrated_mr/real_dat_ukb/result/sib_calibration_bmi.rds")
...
```{r}
# Diabetes
sumstat = readRDS("/project2/mstephens/yunqiyang/calibrated_mr/real_dat_ukb/result/sib_calibration_diabetes.rds")
...
```{r}
# education years
sumstat = readRDS("/project2/mstephens/yunqiyang/calibrated_mr/real_dat_ukb/result/sib_calibration_education_yrs.rds")
