...
```{r}
write.table(data.list$data, "/Users/nicholeyang/Downloads/calibrated_estimator/simulation/dat_ukb/bmi_ea.txt")
```
...
```{r}
write.table(data.list$data, "/Users/nicholeyang/Downloads/calibrated_estimator/simulation/dat_ukb/bmi_t2d.txt")
```
...
```{r}
write.table(data.list$data, "/Users/nicholeyang/Downloads/calibrated_estimator/simulation/dat_ukb/height_ea.txt")
```
