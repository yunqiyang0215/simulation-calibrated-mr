...
data.list <- getInput(sel.file, exp.file, out.file, plink_refdat, max.p.thres = 0.1, 
                      plink_exe = '/Users/nicholeyang/Downloads/calibrated_estimator/simulation/real_data/plink_mac_20230116/plink')

```

```{r}
write.table(data.list$data[, 1], "/Users/nicholeyang/Downloads/calibrated_estimator/simulation/dat_ukb/bmi_ea.txt", quote = TRUE, col.names  = FALSE)
```
...
data.list <- getInput(sel.file, exp.file, out.file, plink_refdat, max.p.thres = 0.05, 
                      plink_exe = '/Users/nicholeyang/Downloads/calibrated_estimator/simulation/real_data/plink_mac_20230116/plink')

```

```{r}
write.table(data.list$data[,1], "/Users/nicholeyang/Downloads/calibrated_estimator/simulation/dat_ukb/bmi_t2d.txt", quote = TRUE, col.names  = FALSE)
```
...
```{r}
write.table(data.list$data[,1], "/Users/nicholeyang/Downloads/calibrated_estimator/simulation/dat_ukb/height_ea.txt", quote = TRUE, col.names  = FALSE)
```
