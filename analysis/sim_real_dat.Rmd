...
$$
\begin{split}
b &= 1, \quad\epsilon \sim N(0, 0.001)\\
...
# 4. Simulate trait
b = 1
Y1 <- 0.1*rowSums(trans) + 0.001*rowSums(nontrans) + rnorm(N, 0, 0.001)
Y2 <- b*Y1 + 0.1*rowSums(trans) + 0.001*rowSums(trans) + rnorm(N, 0, 0.001)
pheno <- cbind(Y1, Y2)
