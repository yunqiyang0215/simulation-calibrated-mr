...
Y_2 &= b*Y_1 + 0.05T_1 +\cdots+0.05T_p + 0.001NT_1 +\cdots+ 0.001NT_p + \epsilon
\end{split}
$$
...
# 4. Simulate trait
b = 1
Y1 <- 0.1*rowSums(trans) + 0.001*rowSums(nontrans) + rnorm(N, 0, 0.1)
Y2 <- b*Y1 + 0.05*rowSums(trans) + 0.001*rowSums(trans) + rnorm(N, 0, 0.01)
pheno <- cbind(Y1, Y2)
