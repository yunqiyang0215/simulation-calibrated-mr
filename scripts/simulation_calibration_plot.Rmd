...
vr = (empirical_var_raw - empirical_var_cali)/empirical_var_raw
plot(x = rep(combinations$pheno.cor, p), y = c(vr), xlab = "phenotypic correlation", ylab = "Empirical variance reduction", pch = 20, xlim = c(0,0.8), cex = 0.5, main = "Sibling data")
...
phe_seq = seq(0, 1, by = 0.01)
theo_vr = (1-0.5)/2*(1-phe_seq)/(1+0.5*phe_seq)
res = readRDS("/project2/mstephens/yunqiyang/calibrated_mr/sim_parametric202404/sibling_logistic_cutoff1.5/res.rds")
