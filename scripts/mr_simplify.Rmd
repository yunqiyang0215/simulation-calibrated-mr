...
```{r}
pdf("/project2/mstephens/yunqiyang/calibrated_mr/simulation-calibrated-mr/output/sim_mr_trio_simplify.pdf",
    height = 6, width = 14)
par(mfrow = c(1,2))
...
combinations <- combinations[c(1:3,6,9), ]
...
arrows(x0 = x_pos, y0 = means - 1.96*ses, x1 = x_pos, y1 = means + 1.96*ses,
       code = 3, angle = 90, length = 0.05, lwd = 4, col = rep(c("coral1", "skyblue", "#F5B35E"), ncomb))
abline(h = 1, lty =2, col = "grey")
points(x = x_pos, y = means, pch = 20)
...
abline(h = 1, lty =2, col = "grey")
points(x = x_pos, y = means, pch = 20)
legend("topleft", legend = c("Calibrated estimator", "Raw estimator", "External GWAS"), lwd = 3, col = c("coral1", "skyblue", "#F5B35E"))
...
```{r}
pdf("/project2/mstephens/yunqiyang/calibrated_mr/simulation-calibrated-mr/output/sim_mr_sibling_simplify.pdf",
    height = 12, width = 14)
par(mfcol = c(2, 2))
...
plot(x = x_pos, y = means, ylim = c(0.2, 2), pch = 20,
     xlab = "Nurture effect vs. noise", ylab = "MR Estimates", main = "Sibling data: IVW", xaxt = 'n')
arrows(x0 = x_pos, y0 = means - 1.96 * ses, x1 = x_pos, y1 = means + 1.96 * ses,
       code = 3, angle = 90, length = 0.05, lwd = 4, col = rep(c("coral1", "skyblue", "gold"), ncomb))
...
plot(1:ncomb, vr, xaxt = 'n', xlab = "Sibling phenotypic correlation", ylab = "Variance reduction", lty = 2, type = "b", pch = 19)
...
plot(x = x_pos, y = means, ylim = c(0.2, 2), pch = 20,
     xlab = "Nurture effect vs. noise", ylab = "MR Estimates", main = "Sibling data: MR.RAPS", xaxt = 'n')
arrows(x0 = x_pos, y0 = means - 1.96 * ses, x1 = x_pos, y1 = means + 1.96 * ses,
       code = 3, angle = 90, length = 0.05, lwd = 4, col = rep(c("coral1", "skyblue", "gold"), ncomb))
