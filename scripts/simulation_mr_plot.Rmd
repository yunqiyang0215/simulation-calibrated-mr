...
par(new = TRUE)
plot(x = x_pos, y = means, ylim = c(0.2, 2), pch = 20,
     xlab = "Phenotypic correlation (exposure, outcome)", ylab = "MR Estimates", main = "Sibling data: IVW", xaxt = 'n')
arrows(x0 = x_pos, y0 = means - 1.96 * ses, x1 = x_pos, y1 = means + 1.96 * ses,
       code = 3, angle = 90, length = 0.05, lwd = 2, col = rep(c("coral1", "skyblue", "gold"), ncomb))
abline(h = 1, lty = 2, col = "grey")
...
par(new = TRUE)
plot(x = x_pos, y = means, ylim = c(0.2, 2), pch = 20,
     xlab = "Phenotypic correlation (exposure, outcome)", ylab = "MR Estimates", main = "Sibling data: MR.RAPS", xaxt = 'n')
arrows(x0 = x_pos, y0 = means - 1.96 * ses, x1 = x_pos, y1 = means + 1.96 * ses,
       code = 3, angle = 90, length = 0.05, lwd = 2, col = rep(c("coral1", "skyblue", "gold"), ncomb))
abline(h = 1, lty = 2, col = "grey")
