# Simulation 2: check the derivation of variance reduction in Binomial case.
...
saveRDS(res.all, "/project2/mstephens/yunqiyang/calibrated_mr/sim_binomial/binomial_rho.rds")
